...
@Component({
  selector: 'app-transport-card-section-b',
  templateUrl: './transport-card-section-b.component.html',
  styleUrls: ['./transport-card-section-b.component.scss']
})
export class TransportCardSectionBComponent implements OnInit {


  @Output() public page = new EventEmitter<PageEvent>();
  @Output() OnClickActionMenu = new EventEmitter();
